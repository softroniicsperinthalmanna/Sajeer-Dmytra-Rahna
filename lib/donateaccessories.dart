...
class donateaccessories extends StatefulWidget {
  const donateaccessories({Key? key}) : super(key: key);

  @override
  State<donateaccessories> createState() => _donateaccessoriesState();
}

class _donateaccessoriesState extends State<donateaccessories> {
  @override
          ...
          Container(
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                ...
                Text("Donate Accessories",style: TextStyle(fontSize: 20)),
